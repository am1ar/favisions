    ...
    <div className="flex flex-col min-h-[100dvh] bg-dark-blue-500 text-white">
      ...
      <main className="flex-1 container px-4 md:px-6 py-12 md:py-24 lg:py-32 text-right">
        ...
        <div className="space-y-8 text-gray-200 text-lg">
          ...
          <section>
            <h2 className="text-3xl font-semibold text-gold-400 mb-4">2. قبول الشروط</h2>
            <p className="mb-4">
          ...
          <section>
            <h2 className="text-3xl font-semibold text-gold-400 mb-4">3. التزامات المستخدم</h2>
          ...
          <section>
            <h2 className="text-3xl font-semibold text-gold-400 mb-4">4. الملكية الفكرية</h2>
            <p className="mb-4">
          ...
          <section>
            <h2 className="text-3xl font-semibold text-gold-400 mb-4">5. حدود المسؤولية</h2>
            <p className="mb-4">
          ...
          <section>
            <h2 className="text-3xl font-semibold text-gold-400 mb-4">6. تعديل الشروط</h2>
            <p className="mb-4">
          ...
          <section>
            <h2 className="text-3xl font-semibold text-gold-400 mb-4">7. القانون الحاكم وحل النزاعات</h2>
            <p className="mb-4">
