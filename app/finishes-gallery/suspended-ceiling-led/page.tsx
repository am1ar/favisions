...
export default function SuspendedCeilingLedPage() {
  return (
          ...
          <div className="container px-4 md:px-6 text-right relative z-10">
            <div className="text-center space-y-8">
              <h1 className="text-4xl font-bold tracking-tighter sm:text-5xl md:text-6xl text-luxury-ivory mb-6 drop-shadow-lg">
                أسقف معلقة مع إضاءات مخفية
              </h1>
              <p className="max-w-3xl mx-auto text-lg md:text-xl text-luxury-ivory/90 leading-relaxed">
                أسقف معلقة فاخرة مع إضاءات LED مخفية وتصاميم هندسية متقنة، مصنوعة من الجبس المقوى مع طلاء مقاوم للرطوبة
              </p>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl text-luxury-navy mb-6">
                  أسقف معلقة مع إضاءات LED
                </h2>
                <p className="text-lg text-dark-text/70 mb-6 leading-relaxed">
                  نقدم أسقف معلقة فاخرة مع إضاءات LED مخفية وتصاميم هندسية متقنة، 
                  مصنوعة من الجبس المقوى مع طلاء مقاوم للرطوبة، تضم مجموعة متنوعة من التصاميم والإضاءات.
                </p>
                <div className="space-y-4">
                  <div className="flex items-center gap-3">
                    <CheckCircle className="h-6 w-6 text-luxury-gold" />
                    <span className="text-dark-text">إضاءات LED مخفية ومتطورة</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <CheckCircle className="h-6 w-6 text-luxury-gold" />
                    <span className="text-dark-text">تصاميم هندسية متقنة</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <CheckCircle className="h-6 w-6 text-luxury-gold" />
                    <span className="text-dark-text">جبس مقوى مع طلاء مقاوم للرطوبة</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <CheckCircle className="h-6 w-6 text-luxury-gold" />
              ...
              <div className="bg-luxury-navy-light p-8 rounded-2xl">
                <div className="text-center space-y-6">
                  <div className="w-20 h-20 bg-luxury-gold rounded-full flex items-center justify-center mx-auto">
                    <Lightbulb className="h-10 w-10 text-luxury-navy" />
                  </div>
                  <h3 className="text-2xl font-bold text-luxury-gold">مميزات الأسقف المعلقة</h3>
                  <div className="space-y-3 text-luxury-ivory/90">
                    <div className="flex items-center gap-2">
                      <ArrowRight className="h-4 w-4 text-luxury-gold" />
                      <span>إضاءات LED مخفية</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <ArrowRight className="h-4 w-4 text-luxury-gold" />
                      <span>تصاميم هندسية</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <ArrowRight className="h-4 w-4 text-luxury-gold" />
                      <span>جبس مقوى</span>
            ...
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
              <div className="text-center space-y-4">
                ...
                <p className="text-dark-text/70 text-sm">
                  دراسة المساحة واختيار التصميم والإضاءات المناسبة للسقف المعلق
                </p>
              </div>
              ...
              <div className="text-center space-y-4">
                ...
                <h3 className="text-xl font-bold text-luxury-navy">إعداد الهيكل</h3>
                <p className="text-dark-text/70 text-sm">
                  إعداد الهيكل المعدني للسقف المعلق وتثبيته بشكل آمن
                </p>
              </div>
              ...
              <div className="text-center space-y-4">
                ...
                <h3 className="text-xl font-bold text-luxury-navy">تركيب الجبس</h3>
                <p className="text-dark-text/70 text-sm">
                  تركيب ألواح الجبس المقوى وتشكيل التصاميم المطلوبة
                </p>
              </div>
              ...
              <div className="text-center space-y-4">
                ...
                <h3 className="text-xl font-bold text-luxury-navy">تركيب الإضاءات</h3>
                <p className="text-dark-text/70 text-sm">
                  تركيب إضاءات LED المخفية وربطها بالكهرباء
                </p>
              </div>
            ...
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
              <Card className="bg-luxury-navy-light text-luxury-ivory border-luxury-gold/30">
                <CardHeader className="flex flex-row-reverse items-center gap-4 pb-4">
                  ...
                  <CardTitle className="text-lg font-bold text-luxury-gold">تصاميم هندسية</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-luxury-ivory/80 text-sm">
                    تصميم الأسقف المعلقة بأحدث التصاميم الهندسية والمتطورة
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="bg-luxury-navy-light text-luxury-ivory border-luxury-gold/30">
                <CardHeader className="flex flex-row-reverse items-center gap-4 pb-4">
                  <div className="w-12 h-12 bg-luxury-gold rounded-full flex items-center justify-center">
                    <Lightbulb className="h-6 w-6 text-luxury-navy" />
                  </div>
                  <CardTitle className="text-lg font-bold text-luxury-gold">إضاءات متطورة</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-luxury-ivory/80 text-sm">
                    استخدام أحدث تقنيات الإضاءة LED المخفية
                  </p>
                </CardContent>
              </Card>
        ...
        <section className="w-full py-16 md:py-24 bg-luxury-ivory">
          <div className="container px-4 md:px-6 text-center">
            <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl mb-6 text-luxury-navy">
              ابدأ مشروع السقف المعلق
            </h2>
            <p className="text-lg text-dark-text/70 max-w-2xl mx-auto mb-8">
              تواصل معنا اليوم للحصول على استشارة مجانية وتصميم السقف المعلق الذي تحتاجونه
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button
                asChild
