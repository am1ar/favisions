...
export default function BotanicalWallpaperPage() {
  return (
          ...
          <div className="container px-4 md:px-6 text-right relative z-10">
            <div className="text-center space-y-8">
              <h1 className="text-4xl font-bold tracking-tighter sm:text-5xl md:text-6xl text-luxury-ivory mb-6 drop-shadow-lg">
                ورق جدران فاخر بتصميم نباتي
              </h1>
              <p className="max-w-3xl mx-auto text-lg md:text-xl text-luxury-ivory/90 leading-relaxed">
                ورق جدران فاخر بتصميم نباتي طبيعي بألوان هادئة وملمس ناعم، مثالي لغرف النوم والاستقبال
              </p>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl text-luxury-navy mb-6">
                  ورق جدران بتصميم نباتي فاخر
                </h2>
                <p className="text-lg text-dark-text/70 mb-6 leading-relaxed">
                  نقدم ورق جدران فاخر بتصميم نباتي طبيعي بألوان هادئة وملمس ناعم، 
                  مثالي لغرف النوم والاستقبال، تضم مجموعة متنوعة من التصاميم والألوان.
                </p>
                <div className="space-y-4">
                  <div className="flex items-center gap-3">
                    <CheckCircle className="h-6 w-6 text-luxury-gold" />
                    <span className="text-dark-text">تصميم نباتي طبيعي</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <CheckCircle className="h-6 w-6 text-luxury-gold" />
                    <span className="text-dark-text">ألوان هادئة ومريحة</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <CheckCircle className="h-6 w-6 text-luxury-gold" />
                    <span className="text-dark-text">ملمس ناعم عالي الجودة</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <CheckCircle className="h-6 w-6 text-luxury-gold" />
              ...
              <div className="bg-luxury-navy-light p-8 rounded-2xl">
                <div className="text-center space-y-6">
                  <div className="w-20 h-20 bg-luxury-gold rounded-full flex items-center justify-center mx-auto">
                    <Leaf className="h-10 w-10 text-luxury-navy" />
                  </div>
                  <h3 className="text-2xl font-bold text-luxury-gold">مميزات ورق الجدران</h3>
                  <div className="space-y-3 text-luxury-ivory/90">
                    <div className="flex items-center gap-2">
                      <ArrowRight className="h-4 w-4 text-luxury-gold" />
                      <span>تصميم نباتي</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <ArrowRight className="h-4 w-4 text-luxury-gold" />
                      <span>ألوان هادئة</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <ArrowRight className="h-4 w-4 text-luxury-gold" />
                      <span>ملمس ناعم</span>
              ...
              <Card className="bg-luxury-navy-light text-luxury-ivory border-luxury-gold/30 text-center">
                ...
                <CardContent>
                  <p className="text-luxury-ivory/80 text-sm">
                    فريق من المهندسين والعمالة الماهرة والمحترفة في تركيب ورق الجدران
                  </p>
                </CardContent>
              </Card>
            ...
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
              <div className="text-center space-y-4">
                ...
                <p className="text-dark-text/70 text-sm">
                  دراسة المساحة واختيار التصميم واللون المناسب لورق الجدران
                </p>
              </div>
              ...
              <div className="text-center space-y-4">
                ...
                <p className="text-dark-text/70 text-sm">
                  تنظيف وإعداد سطح الجدران لتركيب ورق الجدران
                </p>
              </div>
              ...
              <div className="text-center space-y-4">
                ...
                <h3 className="text-xl font-bold text-luxury-navy">تركيب ورق الجدران</h3>
                <p className="text-dark-text/70 text-sm">
                  تركيب ورق الجدران باستخدام تقنيات متطورة ومواد عالية الجودة
                </p>
              </div>
            ...
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
              <Card className="bg-luxury-navy-light text-luxury-ivory border-luxury-gold/30">
                <CardHeader className="flex flex-row-reverse items-center gap-4 pb-4">
                  ...
                  <CardTitle className="text-lg font-bold text-luxury-gold">تصاميم نباتية</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-luxury-ivory/80 text-sm">
                    تصميم ورق الجدران بأحدث التصاميم النباتية والمتطورة
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="bg-luxury-navy-light text-luxury-ivory border-luxury-gold/30">
                <CardHeader className="flex flex-row-reverse items-center gap-4 pb-4">
                  ...
                  <CardTitle className="text-lg font-bold text-luxury-gold">ألوان هادئة</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-luxury-ivory/80 text-sm">
                    اختيار ألوان هادئة ومريحة تناسب جميع التصاميم
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="bg-luxury-navy-light text-luxury-ivory border-luxury-gold/30">
                ...
                <CardContent>
                  <p className="text-luxury-ivory/80 text-sm">
                    استخدام أحدث التقنيات والمواد في تركيب ورق الجدران
                  </p>
                </CardContent>
              </Card>
        ...
        <section className="w-full py-16 md:py-24 bg-luxury-ivory">
          <div className="container px-4 md:px-6 text-center">
            <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl mb-6 text-luxury-navy">
              ابدأ مشروع ورق الجدران
            </h2>
            <p className="text-lg text-dark-text/70 max-w-2xl mx-auto mb-8">
              تواصل معنا اليوم للحصول على استشارة مجانية وتصميم ورق الجدران الذي تحتاجونه
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button
                asChild
