...
export default function NeonCeilingLightsPage() {
  return (
          ...
          <div className="container px-4 md:px-6 text-right relative z-10">
            <div className="text-center space-y-8">
              <h1 className="text-4xl font-bold tracking-tighter sm:text-5xl md:text-6xl text-luxury-ivory mb-6 drop-shadow-lg">
                أسقف معلقة مع إضاءات نيون
              </h1>
              <p className="max-w-3xl mx-auto text-lg md:text-xl text-luxury-ivory/90 leading-relaxed">
                أسقف معلقة حديثة مع إضاءات نيون مخفية وتصاميم عصرية، مصنوعة من الجبس المقوى مع إضاءات LED
              </p>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-lg text-dark-text/70 mb-6 leading-relaxed">
                  نقدم أسقف معلقة حديثة مع إضاءات نيون مخفية وتصاميم عصرية، مصنوعة من الجبس المقوى مع إضاءات LED، 
                  تضفي مظهراً عصرياً وفاخراً على المساحات الداخلية.
                </p>
                <div className="space-y-4">
                  <div className="flex items-center gap-3">
                    <CheckCircle className="h-6 w-6 text-luxury-gold" />
                    <span className="text-dark-text">إضاءات نيون مخفية</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <CheckCircle className="h-6 w-6 text-luxury-gold" />
                    <span className="text-dark-text">تصاميم عصرية</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <CheckCircle className="h-6 w-6 text-luxury-gold" />
                    <span className="text-dark-text">إضاءات LED متطورة</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <CheckCircle className="h-6 w-6 text-luxury-gold" />
              ...
              <div className="bg-luxury-navy-light p-8 rounded-2xl">
                <div className="text-center space-y-6">
                  ...
                  <h3 className="text-2xl font-bold text-luxury-gold">مميزات الإضاءات النيون</h3>
              ...
              <Card className="bg-luxury-navy-light text-luxury-ivory border-luxury-gold/30 text-center">
                ...
                <CardContent>
                  <p className="text-luxury-ivory/80 text-sm">
                    فريق من المهندسين والعمالة الماهرة والمحترفة في تركيب الأسقف المعلقة والإضاءات
                  </p>
                </CardContent>
              </Card>
            ...
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
              <div className="text-center space-y-4">
                ...
                <p className="text-dark-text/70 text-sm">
                  دراسة المساحة واختيار التصميم المناسب ونوع الإضاءات المطلوبة
                </p>
              </div>
              ...
              <div className="text-center space-y-4">
                ...
                <p className="text-dark-text/70 text-sm">
                  إعداد السقف وتركيب الهيكل المعدني للأسقف المعلقة
                </p>
              </div>
              ...
              <div className="text-center space-y-4">
                ...
                <p className="text-dark-text/70 text-sm">
                  تركيب ألواح الجبس المقوى وتشكيل التصميم المطلوب
                </p>
              </div>
              ...
              <div className="text-center space-y-4">
                ...
                <p className="text-dark-text/70 text-sm">
                  تركيب إضاءات النيون LED وربطها بنظام التحكم
                </p>
              </div>
              ...
              <div className="text-center space-y-4">
                ...
                <p className="text-dark-text/70 text-sm">
                  تنفيذ التشطيبات النهائية واختبار الإضاءات
                </p>
              </div>
            ...
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
              <Card className="bg-luxury-navy-light text-luxury-ivory border-luxury-gold/30">
                <CardHeader className="flex flex-row-reverse items-center gap-4 pb-4">
                  ...
                  <CardTitle className="text-lg font-bold text-luxury-gold">إضاءات نيون</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-luxury-ivory/80 text-sm">
                    استخدام إضاءات نيون LED عالية الجودة مع ألوان متعددة
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="bg-luxury-navy-light text-luxury-ivory border-luxury-gold/30">
                ...
                <CardContent>
                  <p className="text-luxury-ivory/80 text-sm">
                    تصميم أسقف معلقة بأحدث التصاميم العصرية والمتطورة
                  </p>
                </CardContent>
              </Card>
        ...
        <section className="w-full py-16 md:py-24 bg-luxury-ivory">
          <div className="container px-4 md:px-6 text-center">
            <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl mb-6 text-luxury-navy">
              ابدأ مشروع الأسقف المعلقة مع الإضاءات
            </h2>
            <p className="text-lg text-dark-text/70 max-w-2xl mx-auto mb-8">
              تواصل معنا اليوم للحصول على استشارة مجانية وتصميم الأسقف المعلقة مع الإضاءات التي تحتاجونها
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button
                asChild
