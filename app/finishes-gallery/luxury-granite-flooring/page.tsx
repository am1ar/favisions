...
export default function LuxuryGraniteFlooringPage() {
  return (
          ...
          <div className="container px-4 md:px-6 text-right relative z-10">
            <div className="text-center space-y-8">
              ...
              <p className="max-w-3xl mx-auto text-lg md:text-xl text-luxury-ivory/90 leading-relaxed">
                أرضيات جرانيت فاخرة ومتينة مع تصميمات عصرية وأنيقة، مثالية للمنازل الفاخرة
              </p>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl text-luxury-navy mb-6">
                  أرضيات الجرانيت الفاخرة
                </h2>
                <p className="text-lg text-dark-text/70 mb-6 leading-relaxed">
                  نقدم أرضيات جرانيت فاخرة ومتينة مع تصميمات عصرية وأنيقة، 
                  مثالية للمنازل الفاخرة، تضم مجموعة متنوعة من الألوان والأنماط.
                </p>
                <div className="space-y-4">
                  <div className="flex items-center gap-3">
                    <CheckCircle className="h-6 w-6 text-luxury-gold" />
                    <span className="text-dark-text">جرانيت طبيعي عالي الجودة</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <CheckCircle className="h-6 w-6 text-luxury-gold" />
                    <span className="text-dark-text">تصميمات عصرية وأنيقة</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <CheckCircle className="h-6 w-6 text-luxury-gold" />
                    <span className="text-dark-text">مثالية للمنازل الفاخرة</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <CheckCircle className="h-6 w-6 text-luxury-gold" />
              ...
              <div className="bg-luxury-navy-light p-8 rounded-2xl">
                <div className="text-center space-y-6">
                  <div className="w-20 h-20 bg-luxury-gold rounded-full flex items-center justify-center mx-auto">
                    <Diamond className="h-10 w-10 text-luxury-navy" />
                  </div>
                  <h3 className="text-2xl font-bold text-luxury-gold">مميزات الجرانيت الفاخر</h3>
                  <div className="space-y-3 text-luxury-ivory/90">
                    <div className="flex items-center gap-2">
                      <ArrowRight className="h-4 w-4 text-luxury-gold" />
                      <span>جرانيت طبيعي</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <ArrowRight className="h-4 w-4 text-luxury-gold" />
                    ...
                    <div className="flex items-center gap-2">
                      <ArrowRight className="h-4 w-4 text-luxury-gold" />
                      <span>تصميمات عصرية</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <ArrowRight className="h-4 w-4 text-luxury-gold" />
                      <span>مقاومة للخدوش</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <ArrowRight className="h-4 w-4 text-luxury-gold" />
              ...
              <Card className="bg-luxury-navy-light text-luxury-ivory border-luxury-gold/30 text-center">
                ...
                <CardContent>
                  <p className="text-luxury-ivory/80 text-sm">
                    فريق من المهندسين والعمالة الماهرة والمحترفة في تركيب أرضيات الجرانيت
                  </p>
                </CardContent>
              </Card>
            ...
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
              <div className="text-center space-y-4">
                ...
                <p className="text-dark-text/70 text-sm">
                  دراسة المساحة واختيار نوع الجرانيت والتصميم المناسب
                </p>
              </div>
              ...
              <div className="text-center space-y-4">
                ...
                <h3 className="text-xl font-bold text-luxury-navy">إعداد الأرضية</h3>
                <p className="text-dark-text/70 text-sm">
                  تنظيف وإعداد الأرضية لتثبيت أرضيات الجرانيت
                </p>
              </div>
              ...
              <div className="text-center space-y-4">
                ...
                <h3 className="text-xl font-bold text-luxury-navy">تركيب الجرانيت</h3>
                <p className="text-dark-text/70 text-sm">
                  تركيب أرضيات الجرانيت باستخدام تقنيات متطورة ومواد عالية الجودة
                </p>
              </div>
            ...
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
              <Card className="bg-luxury-navy-light text-luxury-ivory border-luxury-gold/30">
                <CardHeader className="flex flex-row-reverse items-center gap-4 pb-4">
                  ...
                  <CardTitle className="text-lg font-bold text-luxury-gold">جرانيت طبيعي</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-luxury-ivory/80 text-sm">
                    استخدام جرانيت طبيعي عالي الجودة من أفضل المحاجر العالمية
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="bg-luxury-navy-light text-luxury-ivory border-luxury-gold/30">
                ...
                <CardContent>
                  <p className="text-luxury-ivory/80 text-sm">
                    دقة عالية في تركيب أرضيات الجرانيت لضمان النتيجة المثالية
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="bg-luxury-navy-light text-luxury-ivory border-luxury-gold/30">
                <CardHeader className="flex flex-row-reverse items-center gap-4 pb-4">
                  <div className="w-12 h-12 bg-luxury-gold rounded-full flex items-center justify-center">
                    <Diamond className="h-6 w-6 text-luxury-navy" />
                  </div>
                  <CardTitle className="text-lg font-bold text-luxury-gold">تصميمات فاخرة</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-luxury-ivory/80 text-sm">
                    تصميمات فاخرة وعصرية تناسب جميع أنواع المنازل
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="bg-luxury-navy-light text-luxury-ivory border-luxury-gold/30">
                ...
                <CardContent>
                  <p className="text-luxury-ivory/80 text-sm">
                    استخدام أحدث التقنيات والمواد في تركيب أرضيات الجرانيت
                  </p>
                </CardContent>
              </Card>
        ...
        <section className="w-full py-16 md:py-24 bg-luxury-ivory">
          <div className="container px-4 md:px-6 text-center">
            <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl mb-6 text-luxury-navy">
              ابدأ مشروع الجرانيت الفاخر
            </h2>
            <p className="text-lg text-dark-text/70 max-w-2xl mx-auto mb-8">
              تواصل معنا اليوم للحصول على استشارة مجانية وتصميم أرضيات الجرانيت التي تحتاجونها
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button
                asChild
