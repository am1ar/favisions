...
export default function AdministrativeBuildingsConstructionPage() {
  return (
          ...
          <div className="container px-4 md:px-6 text-right relative z-10">
            <div className="text-center space-y-8">
              <h1 className="text-4xl font-bold tracking-tighter sm:text-5xl md:text-6xl text-luxury-ivory mb-6 drop-shadow-lg">
                بناء المباني الإدارية
              </h1>
              <p className="max-w-3xl mx-auto text-lg md:text-xl text-luxury-ivory/90 leading-relaxed">
                بناء مباني إدارية من عدة طوابق، تضم مكاتب متنوعة وقاعات اجتماعات ومرافق متكاملة
              </p>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-lg text-dark-text/70 mb-6 leading-relaxed">
                  نقدم خدمات بناء المباني الإدارية من عدة طوابق بتصاميم عصرية ومتطورة، تضم مكاتب متنوعة 
                  وقاعات اجتماعات ومرافق متكاملة، مع التركيز على الكفاءة والوظائف العملية.
                </p>
                <div className="space-y-4">
                  <div className="flex items-center gap-3">
                    <CheckCircle className="h-6 w-6 text-luxury-gold" />
                    <span className="text-dark-text">مباني متعددة الطوابق</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <CheckCircle className="h-6 w-6 text-luxury-gold" />
                    <span className="text-dark-text">مكاتب متنوعة</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <CheckCircle className="h-6 w-6 text-luxury-gold" />
                    <span className="text-dark-text">قاعات اجتماعات</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <CheckCircle className="h-6 w-6 text-luxury-gold" />
              ...
              <div className="bg-luxury-navy-light p-8 rounded-2xl">
                <div className="text-center space-y-6">
                  <div className="w-20 h-20 bg-luxury-gold rounded-full flex items-center justify-center mx-auto">
                    <Briefcase className="h-10 w-10 text-luxury-navy" />
                  </div>
                  <h3 className="text-2xl font-bold text-luxury-gold">مميزات المباني الإدارية</h3>
          ...
          <div className="container px-4 md:px-6">
            ...
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
              <Card className="bg-luxury-navy-light text-luxury-ivory border-luxury-gold/30 text-center">
                ...
                <CardContent>
                  <p className="text-luxury-ivory/80 text-sm">
                    فريق من المهندسين والعمالة الماهرة والمحترفة في بناء المباني الإدارية
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="bg-luxury-navy-light text-luxury-ivory border-luxury-gold/30 text-center">
                ...
                <CardContent>
                  <p className="text-luxury-ivory/80 text-sm">
                    ضمان شامل على جميع الأعمال لمدة 20 سنة
                  </p>
                </CardContent>
              </Card>
            </div>
            ...
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
              <div className="text-center space-y-4">
                ...
                <p className="text-dark-text/70 text-sm">
                  دراسة الموقع واختيار التصميم المناسب للمبنى الإداري
                </p>
              </div>
          ...
          <div className="container px-4 md:px-6">
            ...
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
              <Card className="bg-luxury-navy-light text-luxury-ivory border-luxury-gold/30">
                ...
                <CardContent>
                  <p className="text-luxury-ivory/80 text-sm">
                    تصميم مباني إدارية بأحدث التصاميم العصرية والمتطورة
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="bg-luxury-navy-light text-luxury-ivory border-luxury-gold/30">
                <CardHeader className="flex flex-row-reverse items-center gap-4 pb-4">
                  <div className="w-12 h-12 bg-luxury-gold rounded-full flex items-center justify-center">
                    <Briefcase className="h-6 w-6 text-luxury-navy" />
                  </div>
                  <CardTitle className="text-lg font-bold text-luxury-gold">مكاتب متنوعة</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-luxury-ivory/80 text-sm">
                    تصميم مكاتب متنوعة تناسب جميع أنواع الأعمال
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="bg-luxury-navy-light text-luxury-ivory border-luxury-gold/30">
                ...
                <CardContent>
                  <p className="text-luxury-ivory/80 text-sm">
                    استخدام أحدث التقنيات والمواد في بناء المباني الإدارية
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="bg-luxury-navy-light text-luxury-ivory border-luxury-gold/30">
                ...
                <CardContent>
                  <p className="text-luxury-ivory/80 text-sm">
                    ضمان شامل على جميع الأعمال لمدة 20 سنة مع خدمة ما بعد البيع
                  </p>
                </CardContent>
              </Card>
        ...
        <section className="w-full py-16 md:py-24 bg-luxury-ivory">
          <div className="container px-4 md:px-6 text-center">
            <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl mb-6 text-luxury-navy">
              ابدأ مشروع بناء المبنى الإداري
            </h2>
            <p className="text-lg text-dark-text/70 max-w-2xl mx-auto mb-8">
              تواصل معنا اليوم للحصول على استشارة مجانية وتصميم المبنى الإداري الذي تحتاجونه
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button
                asChild
