...
export default function HotelsResortsConstructionPage() {
  return (
          ...
          <div className="container px-4 md:px-6 text-right relative z-10">
            <div className="text-center space-y-8">
              ...
              <p className="max-w-3xl mx-auto text-lg md:text-xl text-luxury-ivory/90 leading-relaxed">
                خدمات بناء الفنادق والمنتجعات الفاخرة بأعلى معايير الجودة والاحترافية. نعمل مع مقاولين محترفين لتقديم مرافق سياحية فاخرة ومتطورة
              </p>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl text-luxury-navy mb-6">
                  خدمات بناء الفنادق والمنتجعات
                </h2>
                <p className="text-lg text-dark-text/70 mb-6 leading-relaxed">
                  نقدم خدمات بناء الفنادق والمنتجعات المتكاملة بتصاميم فاخرة ومتطورة، 
                  تضم غرف فاخرة ومطاعم ومرافق ترفيهية متكاملة تناسب جميع أنواع السياحة.
                </p>
                <div className="space-y-4">
                  ...
                  <div className="flex items-center gap-3">
                    <CheckCircle className="h-6 w-6 text-luxury-gold" />
                    <span className="text-dark-text">غرف فاخرة ومطاعم متطورة</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <CheckCircle className="h-6 w-6 text-luxury-gold" />
              ...
              <div className="bg-luxury-navy-light p-8 rounded-2xl">
                <div className="text-center space-y-6">
                  <div className="w-20 h-20 bg-luxury-gold rounded-full flex items-center justify-center mx-auto">
                    <Hotel className="h-10 w-10 text-luxury-navy" />
                  </div>
                  <h3 className="text-2xl font-bold text-luxury-gold">مميزات الفنادق والمنتجعات</h3>
                  <div className="space-y-3 text-luxury-ivory/90">
                    <div className="flex items-center gap-2">
                      <ArrowRight className="h-4 w-4 text-luxury-gold" />
                      <span>غرف فاخرة متعددة</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <ArrowRight className="h-4 w-4 text-luxury-gold" />
                      <span>مطاعم فاخرة</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <ArrowRight className="h-4 w-4 text-luxury-gold" />
                      <span>مرافق ترفيهية</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <ArrowRight className="h-4 w-4 text-luxury-gold" />
                      <span>حمامات سباحة</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <ArrowRight className="h-4 w-4 text-luxury-gold" />
              ...
              <Card className="bg-luxury-navy-light text-luxury-ivory border-luxury-gold/30 text-center">
                ...
                <CardContent>
                  <p className="text-luxury-ivory/80 text-sm">
                    فريق من المهندسين والعمالة الماهرة والمحترفة في بناء الفنادق والمنتجعات
                  </p>
                </CardContent>
              </Card>
            ...
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
              <div className="text-center space-y-4">
                ...
                <p className="text-dark-text/70 text-sm">
                  دراسة الموقع وتصميم الفندق أو المنتجع بما يتناسب مع احتياجات السياحة والمساحة المتاحة
                </p>
              </div>
              ...
              <div className="text-center space-y-4">
                ...
                <p className="text-dark-text/70 text-sm">
                  إعداد الموقع وتجهيز الأساسات والبنية التحتية المطلوبة للفندق أو المنتجع
                </p>
              </div>
              ...
              <div className="text-center space-y-4">
                ...
                <p className="text-dark-text/70 text-sm">
                  بناء الفندق أو المنتجع باستخدام مواد فاخرة عالية الجودة وتقنيات متطورة
                </p>
              </div>
          ...
          <div className="container px-4 md:px-6">
            ...
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
              <Card className="bg-luxury-navy-light text-luxury-ivory border-luxury-gold/30">
                ...
                <CardContent>
                  <p className="text-luxury-ivory/80 text-sm">
                    تصميم الفنادق والمنتجعات بأحدث التصاميم الفاخرة والمتطورة
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="bg-luxury-navy-light text-luxury-ivory border-luxury-gold/30">
                ...
                <CardContent>
                  <p className="text-luxury-ivory/80 text-sm">
                    تصميم مساحات واسعة ومريحة تناسب الفنادق والمنتجعات
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="bg-luxury-navy-light text-luxury-ivory border-luxury-gold/30">
                ...
                <CardContent>
                  <p className="text-luxury-ivory/80 text-sm">
                    اختيار ألوان فاخرة ومتناسقة تناسب الفنادق والمنتجعات
                  </p>
                </CardContent>
              </Card>
        ...
        <section className="w-full py-16 md:py-24 bg-luxury-ivory">
          <div className="container px-4 md:px-6 text-center">
            <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl mb-6 text-luxury-navy">
              ابدأ مشروع الفندق أو المنتجع
            </h2>
            <p className="text-lg text-dark-text/70 max-w-2xl mx-auto mb-8">
              تواصل معنا اليوم للحصول على استشارة مجانية وتصميم الفندق أو المنتجع الذي تحتاجونه
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button
                asChild
