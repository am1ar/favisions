...
export default function MultiColorWardrobeDetailPage() {
  return (
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <h1 className="text-4xl font-bold tracking-tighter sm:text-5xl md:text-6xl text-luxury-ivory mb-6 drop-shadow-lg">
                  خزانة ملابس حديثة مع إضاءة متعددة الألوان
                </h1>
                <p className="text-lg md:text-xl text-luxury-ivory/90 leading-relaxed mb-8">
                  خزانة ملابس حديثة وفاخرة مع إضاءة LED متكاملة بألوان دافئة وباردة، مصنوعة من خشب داكن عالي الجودة
                </p>
                ...
                <div className="flex items-center gap-6 text-sm text-luxury-ivory/80">
                  <div className="flex items-center gap-2">
                    ...
                    <span>14 يناير 2024</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <Eye className="h-4 w-4" />
                    <span>1,678 مشاهدة</span>
                  </div>
                  <div className="flex items-center gap-2">
              ...
              <div className="relative">
                <div className="relative w-full h-80 md:h-96 rounded-2xl overflow-hidden shadow-2xl">
                  <Image
                    src="/woodworking-images/multi-color-wardrobe.svg"
                    alt="خزانة ملابس حديثة مع إضاءة متعددة الألوان"
                    fill
                    className="object-cover"
                  />
                  <Image
                    src="/woodworking-images/ng/4.jpg"
                    alt="خزانة ملابس حديثة مع إضاءة متعددة الألوان"
                    fill
                    className="object-cover"
                  />
            ...
            <div className="grid lg:grid-cols-3 gap-12">
              ...
              <div className="lg:col-span-2 space-y-12">
                ...
                <Card className="bg-white border-luxury-gold/30 shadow-xl">
                  ...
                  <CardContent className="space-y-6">
                    <p className="text-dark-text/80 leading-relaxed text-lg">
                      هذه الخزانة تمثل ثورة في عالم تصميم خزائن الملابس، حيث تم دمج التصميم العصري مع تقنيات الإضاءة المتطورة. نظام الإضاءة متعدد الألوان يوفر تجربة فريدة من نوعها مع إمكانية تخصيص الألوان حسب المزاج والمناسبة.
                    </p>
                    <p className="text-dark-text/80 leading-relaxed text-lg">
                      تم استخدام خشب الجوز عالي الجودة مع تشطيب احترافي يبرز جمال الحبيبات الطبيعية. الإضاءة LED المتطورة تضمن رؤية مثالية للملابس مع إضافة لمسة فنية وعصرية للمساحة.
                    </p>
                  </CardContent>
                </Card>
                  ...
                  <CardContent>
                    <div className="grid md:grid-cols-2 gap-6">
                      <div className="space-y-4">
                        ...
                        <div className="flex items-center justify-between p-4 bg-luxury-ivory rounded-lg">
                          <span className="font-medium text-dark-text">نظام الإضاءة</span>
                          <span className="text-dark-text/70">LED متعدد الألوان</span>
                        </div>
                        <div className="flex items-center justify-between p-4 bg-luxury-ivory rounded-lg">
                          <span className="font-medium text-dark-text">الأبعاد</span>
                          <span className="text-dark-text/70">4.2 × 3.0 × 2.6 متر</span>
                        </div>
                      </div>
                      <div className="space-y-4">
                        <div className="flex items-center justify-between p-4 bg-luxury-ivory rounded-lg">
                          <span className="font-medium text-dark-text">مدة التنفيذ</span>
                          <span className="text-dark-text/70">5-7 أسابيع</span>
                        </div>
                        <div className="flex items-center justify-between p-4 bg-luxury-ivory rounded-lg">
                ...
                <Card className="bg-white border-luxury-gold/30 shadow-xl">
                  <CardHeader>
                    <CardTitle className="text-2xl font-bold text-luxury-navy flex items-center gap-3">
                      <Lightbulb className="h-6 w-6 text-luxury-gold" />
                      نظام الإضاءة متعدد الألوان
                    </CardTitle>
                  </CardHeader>
                  <CardContent className="space-y-6">
                    <p className="text-dark-text/80 leading-relaxed text-lg">
                      نظام الإضاءة متعدد الألوان هو القلب النابض لهذه الخزانة الفريدة. يمكن تخصيص الألوان حسب المزاج والمناسبة، مما يوفر تجربة فريدة من نوعها في عالم خزائن الملابس.
                    </p>
                    <div className="grid md:grid-cols-2 gap-6">
                      <div className="space-y-4">
                        <div className="flex items-start gap-3">
                          <div className="w-2 h-2 bg-luxury-gold rounded-full mt-2"></div>
                          <span className="text-dark-text/80">16 مليون لون قابل للتخصيص</span>
                        </div>
                        <div className="flex items-start gap-3">
                          <div className="w-2 h-2 bg-luxury-gold rounded-full mt-2"></div>
                          <span className="text-dark-text/80">تحكم عن بعد عبر الهاتف الذكي</span>
                        </div>
                        <div className="flex items-start gap-3">
                          <div className="w-2 h-2 bg-luxury-gold rounded-full mt-2"></div>
                          <span className="text-dark-text/80">أوضاع إضاءة مبرمجة مسبقاً</span>
                        </div>
                      </div>
                      <div className="space-y-4">
                        <div className="flex items-start gap-3">
                          <div className="w-2 h-2 bg-luxury-gold rounded-full mt-2"></div>
                          <span className="text-dark-text/80">إضاءة تلقائية عند فتح الأبواب</span>
                        </div>
                        <div className="flex items-start gap-3">
                          <div className="w-2 h-2 bg-luxury-gold rounded-full mt-2"></div>
                          <span className="text-dark-text/80">تدرج ألوان متحرك</span>
                        </div>
                        <div className="flex items-start gap-3">
                          <div className="w-2 h-2 bg-luxury-gold rounded-full mt-2"></div>
                          <span className="text-dark-text/80">توفير في استهلاك الطاقة</span>
                        </div>
                      </div>
                    </div>
                  </CardContent>
                  ...
                  <CardContent>
                    <div className="grid md:grid-cols-2 gap-6">
                      <div className="space-y-4">
                        <div className="flex items-start gap-3">
                          <div className="w-2 h-2 bg-luxury-gold rounded-full mt-2"></div>
                          <span className="text-dark-text/80">تصميم عصري مع خطوط مستقيمة</span>
                        </div>
                        <div className="flex items-start gap-3">
                          <div className="w-2 h-2 bg-luxury-gold rounded-full mt-2"></div>
                        ...
                        <div className="flex items-start gap-3">
                          <div className="w-2 h-2 bg-luxury-gold rounded-full mt-2"></div>
                          <span className="text-dark-text/80">أبواب زجاجية مع إطارات خشبية</span>
                        </div>
                      </div>
                      <div className="space-y-4">
                        <div className="flex items-start gap-3">
                        ...
                        <div className="flex items-start gap-3">
                          <div className="w-2 h-2 bg-luxury-gold rounded-full mt-2"></div>
                          <span className="text-dark-text/80">خزائن مغلقة مع أقفال إلكترونية</span>
                        </div>
                        <div className="flex items-start gap-3">
                          <div className="w-2 h-2 bg-luxury-gold rounded-full mt-2"></div>
                          <span className="text-dark-text/80">مرآة ذكية مع إضاءة محيطة</span>
                        </div>
                      </div>
                    </div>
                  </CardContent>
              ...
              <div className="space-y-6">
                ...
                <Card className="bg-white border-luxury-gold/30 shadow-xl">
                  ...
                  <CardContent className="space-y-4">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="font-bold text-luxury-navy">1,678</span>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-dark-text/70">الإعجابات</span>
                      <span className="font-bold text-luxury-navy">143</span>
                    </div>
                    <div className="flex items-center justify-between">
                ...
                <Card className="bg-luxury-navy text-luxury-ivory border-luxury-gold/30 shadow-xl">
                  <CardHeader>
                    <CardTitle className="text-xl font-bold text-luxury-ivory">
                      هل تريد خزانة ملابس متطورة؟
                    </CardTitle>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    <p className="text-luxury-ivory/80 text-sm">
                      تواصل معنا اليوم للحصول على استشارة مجانية وتصميم خزانة ملابسك المتطورة
                    </p>
                    <Button
                      asChild
                ...
                <Card className="bg-white border-luxury-gold/30 shadow-xl">
                  ...
                  <CardContent className="space-y-4">
                    <Link href="/woodworking-gallery/art-deco-wardrobe" className="block p-4 bg-luxury-ivory rounded-lg hover:bg-luxury-gold/10 transition-colors">
                      <h4 className="font-semibold text-dark-text mb-2">خزانة ملابس كلاسيكية مع تصميم آرت ديكو</h4>
                      <p className="text-sm text-dark-text/70">خزانة ملابس كلاسيكية بتأثيرات آرت ديكو</p>
                    </Link>
        ...
        <section className="w-full py-16 md:py-24 bg-luxury-navy text-luxury-ivory">
          <div className="container px-4 md:px-6 text-center">
            <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl mb-6">
              هل أعجبتك هذه الخزانة المتطورة؟
            </h2>
            <p className="text-lg text-luxury-ivory/80 max-w-2xl mx-auto mb-8">
              تواصل معنا اليوم للحصول على استشارة مجانية وتصميم خزانة ملابسك المتطورة بأعلى معايير الجودة
            </p>
