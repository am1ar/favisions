...
export default function AdvancedLEDWardrobeDetailPage() {
  return (
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <h1 className="text-4xl font-bold tracking-tighter sm:text-5xl md:text-6xl text-luxury-ivory mb-6 drop-shadow-lg">
                  خزانة ملابس فاخرة مع إضاءة LED متطورة
                </h1>
                <p className="text-lg md:text-xl text-luxury-ivory/90 leading-relaxed mb-8">
                  خزانة ملابس فاخرة مع إضاءة LED متطورة وخشب طبيعي عالي الجودة، مصممة بأسلوب عصري مع تقنيات إضاءة متقدمة
                </p>
                ...
                <div className="flex items-center gap-6 text-sm text-luxury-ivory/80">
                  <div className="flex items-center gap-2">
                    ...
                    <span>5 ديسمبر 2023</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <Eye className="h-4 w-4" />
                    <span>3,567 مشاهدة</span>
                  </div>
                  <div className="flex items-center gap-2">
              ...
              <div className="relative">
                <div className="relative w-full h-80 md:h-96 rounded-2xl overflow-hidden shadow-2xl">
                  <Image
                    src="/woodworking-images/advanced-led-wardrobe.svg"
                    alt="خزانة ملابس فاخرة مع إضاءة LED متطورة"
                    fill
                    className="object-cover"
                  />
                  <Image
                    src="/woodworking-images/ng/10.jpg"
                    alt="خزانة ملابس فاخرة مع إضاءة LED متطورة"
                    fill
                    className="object-cover"
                  />
            ...
            <div className="grid lg:grid-cols-3 gap-12">
                ...
                <Card className="bg-white border-luxury-gold/30 shadow-xl">
                  ...
                  <CardContent className="space-y-6">
                    <p className="text-dark-text/80 leading-relaxed text-lg">
                      هذه الخزانة تمثل مثالاً رائعاً على التصميم العصري والتقني، حيث تم استخدام إضاءة LED متطورة مع خشب البلوط الطبيعي لإنشاء خزائن أنيقة تعمل بكفاءة عالية. التصميم يجمع بين الأناقة المعاصرة والتقنيات المتقدمة.
                    </p>
                    <p className="text-dark-text/80 leading-relaxed text-lg">
                      إضاءة LED المتطورة توفر تجربة بصرية فريدة مع الحفاظ على كفاءة الطاقة، مع تصميم عصري ومينيمال يناسب جميع أنواع المنازل. تم استخدام مواد عالية الجودة لضمان المتانة والاستدامة.
                    </p>
                  </CardContent>
                </Card>
                  ...
                  <CardContent>
                    <div className="grid md:grid-cols-2 gap-6">
                      <div className="space-y-4">
                        ...
                        <div className="flex items-center justify-between p-4 bg-luxury-ivory rounded-lg">
                          <span className="font-medium text-dark-text">نوع الإضاءة</span>
                          <span className="text-dark-text/70">LED متطورة</span>
                        </div>
                        <div className="flex items-center justify-between p-4 bg-luxury-ivory rounded-lg">
                          <span className="font-medium text-dark-text">الأبعاد</span>
                          <span className="text-dark-text/70">3.8 × 2.9 × 2.7 متر</span>
                        </div>
                      </div>
                      <div className="space-y-4">
                        <div className="flex items-center justify-between p-4 bg-luxury-ivory rounded-lg">
                  ...
                  <CardContent>
                    <div className="grid md:grid-cols-2 gap-6">
                      <div className="space-y-4">
                        ...
                        <div className="flex items-start gap-3">
                          <div className="w-2 h-2 bg-luxury-gold rounded-full mt-2"></div>
                          <span className="text-dark-text/80">إضاءة LED متطورة وقابلة للتحكم</span>
                        </div>
                        <div className="flex items-start gap-3">
                          <div className="w-2 h-2 bg-luxury-gold rounded-full mt-2"></div>
                          <span className="text-dark-text/80">تقنيات إضاءة ذكية</span>
                        </div>
                      </div>
                      <div className="space-y-4">
                        <div className="flex items-start gap-3">
              ...
              <div className="space-y-6">
                ...
                <Card className="bg-white border-luxury-gold/30 shadow-xl">
                  ...
                  <CardContent className="space-y-4">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="font-bold text-luxury-navy">3,567</span>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-dark-text/70">الإعجابات</span>
                      <span className="font-bold text-luxury-navy">278</span>
                    </div>
                    <div className="flex items-center justify-between">
                ...
                <Card className="bg-white border-luxury-gold/30 shadow-xl">
                  ...
                  <CardContent className="space-y-4">
                    <Link href="/woodworking-gallery/warm-light-wardrobe" className="block p-4 bg-luxury-ivory rounded-lg hover:bg-luxury-gold/10 transition-colors">
                      <h4 className="font-semibold text-dark-text mb-2">خزانة ملابس فاخرة مع إضاءة دافئة</h4>
                      <p className="text-sm text-dark-text/70">خزانة ملابس فاخرة مع إضاءة دافئة</p>
                    </Link>
