...
export default function LuxuryWardrobeDetailPage() {
  return (
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <h1 className="text-4xl font-bold tracking-tighter sm:text-5xl md:text-6xl text-luxury-ivory mb-6 drop-shadow-lg">
                  خزانة ملابس فاخرة مع إضاءة LED متكاملة
                </h1>
                <p className="text-lg md:text-xl text-luxury-ivory/90 leading-relaxed mb-8">
                  خزانة ملابس فاخرة مصممة بشكل متماثل على شكل حرف U مع إضاءة LED متكاملة، مصنوعة من خشب داكن عالي الجودة
                </p>
              ...
              <div className="relative">
                <div className="relative w-full h-80 md:h-96 rounded-2xl overflow-hidden shadow-2xl">
                                                <Image
                                src="/woodworking-images/luxury-wardrobe-1.svg"
                                alt="خزانة ملابس فاخرة مع إضاءة LED متكاملة"
                                fill
                                className="object-cover"
                              />
                  <Image
                    src="/woodworking-images/ng/2.jpg"
                    alt="خزانة ملابس فاخرة مع إضاءة LED متكاملة"
                    fill
                    className="object-cover"
                  />
            ...
            <div className="grid lg:grid-cols-3 gap-12">
                ...
                <Card className="bg-white border-luxury-gold/30 shadow-xl">
                  ...
                  <CardContent className="space-y-6">
                    <p className="text-dark-text/80 leading-relaxed text-lg">
                      هذه الخزانة تمثل قمة التميز في تصميم خزائن الملابس الفاخرة، حيث تم دمج الأناقة الكلاسيكية مع التقنيات الحديثة. التصميم على شكل حرف U يوفر مساحة تخزين مثالية مع سهولة الوصول لجميع العناصر.
                    </p>
                    <p className="text-dark-text/80 leading-relaxed text-lg">
                      تم استخدام خشب الجوز عالي الجودة مع تشطيب احترافي يبرز جمال الحبيبات الطبيعية. نظام الإضاءة LED المتكامل يوفر إضاءة مثالية لاختيار الملابس مع إضافة لمسة عصرية وأنيقة للمساحة.
                    </p>
                  </CardContent>
                </Card>
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                      <div className="space-y-4">
                        ...
                        <div className="flex items-center justify-between p-4 bg-luxury-ivory rounded-lg">
                          ...
                          <span className="text-dark-text/70">LED متكامل</span>
                        </div>
                        <div className="flex items-center justify-between p-4 bg-luxury-ivory rounded-lg">
                          <span className="font-medium text-dark-text">الأبعاد</span>
                          <span className="text-dark-text/70">3.5 × 2.8 × 2.4 متر</span>
                        </div>
                      </div>
                      <div className="space-y-4">
                        <div className="flex items-center justify-between p-4 bg-luxury-ivory rounded-lg">
                        ...
                        <div className="flex items-center justify-between p-4 bg-luxury-ivory rounded-lg">
                          ...
                          <span className="text-dark-text/70">7 سنوات</span>
                        </div>
                        <div className="flex items-center justify-between p-4 bg-luxury-ivory rounded-lg">
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                      <div className="space-y-4">
                        <div className="flex items-start gap-3">
                          ...
                          <span className="text-dark-text/80">تصميم على شكل حرف U يوفر مساحة تخزين مثالية</span>
                        </div>
                        <div className="flex items-start gap-3">
                          <div className="w-2 h-2 bg-luxury-gold rounded-full mt-2"></div>
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="flex items-start gap-3">
                          <div className="w-2 h-2 bg-luxury-gold rounded-full mt-2"></div>
                          <span className="text-dark-text/80">مرآة كاملة الطول مع إضاءة محيطة</span>
                        </div>
                      </div>
                    </div>
                  </CardContent>
                ...
                <Card className="bg-white border-luxury-gold/30 shadow-xl">
                  <CardHeader>
                    <CardTitle className="text-2xl font-bold text-luxury-navy flex items-center gap-3">
                      ...
                      نظام الإضاءة المتكامل
                    </CardTitle>
                  </CardHeader>
                  <CardContent className="space-y-6">
                    <p className="text-dark-text/80 leading-relaxed text-lg">
                      تم تصميم نظام الإضاءة بعناية فائقة ليوفر إضاءة مثالية في جميع أقسام الخزانة. الإضاءة LED المتكاملة تضمن رؤية واضحة للملابس مع إضافة لمسة عصرية وأنيقة.
                    </p>
                    <div className="grid md:grid-cols-2 gap-6">
                      <div className="space-y-4">
                        <div className="flex items-start gap-3">
                          <div className="w-2 h-2 bg-luxury-gold rounded-full mt-2"></div>
                          <span className="text-dark-text/80">إضاءة LED في جميع الرفوف</span>
                        </div>
                        <div className="flex items-start gap-3">
                          <div className="w-2 h-2 bg-luxury-gold rounded-full mt-2"></div>
                          <span className="text-dark-text/80">إضاءة محيطة للمرآة</span>
                        </div>
                        <div className="flex items-start gap-3">
                          <div className="w-2 h-2 bg-luxury-gold rounded-full mt-2"></div>
                          <span className="text-dark-text/80">تحكم في شدة الإضاءة</span>
                        </div>
                      </div>
                      <div className="space-y-4">
                        <div className="flex items-start gap-3">
                        ...
                        <div className="flex items-start gap-3">
                          <div className="w-2 h-2 bg-luxury-gold rounded-full mt-2"></div>
                          <span className="text-dark-text/80">ألوان إضاءة قابلة للتغيير</span>
                        </div>
                        <div className="flex items-start gap-3">
                          <div className="w-2 h-2 bg-luxury-gold rounded-full mt-2"></div>
              ...
              <div className="space-y-6">
                ...
                <Card className="bg-white border-luxury-gold/30 shadow-xl">
                  ...
                  <CardContent className="space-y-4">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="font-bold text-luxury-navy">1,892</span>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-dark-text/70">الإعجابات</span>
                      <span className="font-bold text-luxury-navy">156</span>
                    </div>
                    <div className="flex items-center justify-between">
                ...
                <Card className="bg-luxury-navy text-luxury-ivory border-luxury-gold/30 shadow-xl">
                  ...
                  <CardContent className="space-y-4">
                    <p className="text-luxury-ivory/80 text-sm">
                      تواصل معنا اليوم للحصول على استشارة مجانية وتصميم خزانة ملابسك الفريدة
                    </p>
                    <Button
                      asChild
                ...
                <Card className="bg-white border-luxury-gold/30 shadow-xl">
                  ...
                  <CardContent className="space-y-4">
                    <Link href="/woodworking-gallery/light-wood-wardrobe" className="block p-4 bg-luxury-ivory rounded-lg hover:bg-luxury-gold/10 transition-colors">
                      <h4 className="font-semibold text-dark-text mb-2">خزانة ملابس فاخرة من الخشب الفاتح</h4>
        ...
        <section className="w-full py-16 md:py-24 bg-luxury-navy text-luxury-ivory">
          <div className="container px-4 md:px-6 text-center">
            <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl mb-6">
              هل أعجبتك هذه الخزانة؟
            </h2>
            <p className="text-lg text-luxury-ivory/80 max-w-2xl mx-auto mb-8">
              تواصل معنا اليوم للحصول على استشارة مجانية وتصميم خزانة ملابسك الفريدة بأعلى معايير الجودة
            </p>
