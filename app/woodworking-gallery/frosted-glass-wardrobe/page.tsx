...
export default function FrostedGlassWardrobeDetailPage() {
  return (
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <h1 className="text-4xl font-bold tracking-tighter sm:text-5xl md:text-6xl text-luxury-ivory mb-6 drop-shadow-lg">
                  خزانة ملابس فاخرة مع زجاج معتم
                </h1>
                <p className="text-lg md:text-xl text-luxury-ivory/90 leading-relaxed mb-8">
                  خزانة ملابس فاخرة مع أبواب زجاجية معتمة وخشب فاتح طبيعي، مصممة بأسلوب معاصر مع إضاءة LED متكاملة
                </p>
                ...
                <div className="flex items-center gap-6 text-sm text-luxury-ivory/80">
                  <div className="flex items-center gap-2">
                    ...
                    <span>18 ديسمبر 2023</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <Eye className="h-4 w-4" />
                    <span>1,876 مشاهدة</span>
                  </div>
                  <div className="flex items-center gap-2">
              ...
              <div className="relative">
                <div className="relative w-full h-80 md:h-96 rounded-2xl overflow-hidden shadow-2xl">
                  <Image
                    src="/woodworking-images/frosted-glass-wardrobe.svg"
                    alt="خزانة ملابس فاخرة مع زجاج معتم"
                    fill
                    className="object-cover"
                  />
                  <Image
                    src="/woodworking-images/ng/17.jpg"
                    alt="خزانة ملابس فاخرة مع زجاج معتم"
                    fill
                    className="object-cover"
                  />
                ...
                <Card className="bg-white border-luxury-gold/30 shadow-xl">
                  ...
                  <CardContent className="space-y-6">
                    <p className="text-dark-text/80 leading-relaxed text-lg">
                      هذه الخزانة تمثل مثالاً رائعاً على التصميم المعاصر والفاخر، حيث تم استخدام زجاج معتم مع خشب البلوط الفاتح لإنشاء خزائن أنيقة تعمل بكفاءة عالية. التصميم يجمع بين الأناقة المعاصرة والراحة العملية.
                    </p>
                    <p className="text-dark-text/80 leading-relaxed text-lg">
                      الزجاج المعتم يوفر خصوصية مع الحفاظ على الشفافية البصرية، مع تصميم عصري ومينيمال يناسب جميع أنواع المنازل. تم استخدام مواد عالية الجودة لضمان المتانة والاستدامة.
                    </p>
                  </CardContent>
                </Card>
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                      <div className="space-y-4">
                        ...
                        <div className="flex items-center justify-between p-4 bg-luxury-ivory rounded-lg">
                          ...
                          <span className="text-dark-text/70">زجاج معتم</span>
                        </div>
                        <div className="flex items-center justify-between p-4 bg-luxury-ivory rounded-lg">
                          <span className="font-medium text-dark-text">الأبعاد</span>
                          <span className="text-dark-text/70">3.2 × 2.6 × 2.4 متر</span>
                        </div>
                      </div>
                      <div className="space-y-4">
                        <div className="flex items-center justify-between p-4 bg-luxury-ivory rounded-lg">
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                      <div className="space-y-4">
                        <div className="flex items-start gap-3">
                          ...
                          <span className="text-dark-text/80">خشب بلوط فاتح عالي الجودة</span>
                        </div>
                        <div className="flex items-start gap-3">
                          <div className="w-2 h-2 bg-luxury-gold rounded-full mt-2"></div>
                          <span className="text-dark-text/80">أبواب زجاجية معتمة</span>
                        </div>
                        <div className="flex items-start gap-3">
                          <div className="w-2 h-2 bg-luxury-gold rounded-full mt-2"></div>
                ...
                <Card className="bg-white border-luxury-gold/30 shadow-xl">
                  ...
                  <CardContent className="space-y-4">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="font-bold text-luxury-navy">1,876</span>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-dark-text/70">الإعجابات</span>
                      <span className="font-bold text-luxury-navy">145</span>
                    </div>
                    <div className="flex items-center justify-between">
                ...
                <Card className="bg-white border-luxury-gold/30 shadow-xl">
                  ...
                  <CardContent className="space-y-4">
                    <Link href="/woodworking-gallery/light-wood-wardrobe" className="block p-4 bg-luxury-ivory rounded-lg hover:bg-luxury-gold/10 transition-colors">
                      ...
                      <p className="text-sm text-dark-text/70">خزانة ملابس فاخرة من الخشب الفاتح</p>
                    </Link>
