...
export default function GlassWoodShowroomDetailPage() {
  return (
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <h1 className="text-4xl font-bold tracking-tighter sm:text-5xl md:text-6xl text-luxury-ivory mb-6 drop-shadow-lg">
                  معرض داخلي مع أبواب خشبية وزجاجية
                </h1>
                <p className="text-lg md:text-xl text-luxury-ivory/90 leading-relaxed mb-8">
                  معرض داخلي فاخر مع أبواب خشبية وزجاجية عالية الجودة، مصمم بأسلوب عصري مع مزيج مثالي من الأناقة والشفافية
                </p>
              ...
              <div className="relative">
                <div className="relative w-full h-80 md:h-96 rounded-2xl overflow-hidden shadow-2xl">
                  <Image
                    src="/woodworking-images/glass-wood-showroom.svg"
                    alt="معرض داخلي مع أبواب خشبية وزجاجية"
                    fill
                    className="object-cover"
                  />
                  <Image
                    src="/woodworking-images/ng/7.jpg"
                    alt="معرض داخلي مع أبواب خشبية وزجاجية"
                    fill
                    className="object-cover"
                  />
            ...
            <div className="grid lg:grid-cols-3 gap-12">
                ...
                <Card className="bg-white border-luxury-gold/30 shadow-xl">
                  ...
                  <CardContent className="space-y-6">
                    <p className="text-dark-text/80 leading-relaxed text-lg">
                      هذا المعرض الداخلي يمثل مثالاً رائعاً على التصميم العصري والفاخر، حيث تم استخدام أبواب خشبية وزجاجية عالية الجودة لإنشاء مساحة عرض أنيقة تعمل بكفاءة عالية. التصميم يجمع بين الأناقة المعاصرة والشفافية البصرية.
                    </p>
                    <p className="text-dark-text/80 leading-relaxed text-lg">
                      الأبواب الزجاجية توفر رؤية واضحة للمعروضات مع الحفاظ على الأمان، مع تصميم عصري ومينيمال يناسب جميع أنواع المعارض. تم استخدام مواد عالية الجودة لضمان المتانة والاستدامة.
                    </p>
                  </CardContent>
                </Card>
                  ...
                  <CardContent>
                    <div className="grid md:grid-cols-2 gap-6">
                      <div className="space-y-4">
                        ...
                        <div className="flex items-center justify-between p-4 bg-luxury-ivory rounded-lg">
                          <span className="font-medium text-dark-text">نوع الزجاج</span>
                          <span className="text-dark-text/70">زجاج أمان</span>
                        </div>
                        <div className="flex items-center justify-between p-4 bg-luxury-ivory rounded-lg">
                          <span className="font-medium text-dark-text">الأبعاد</span>
                          <span className="text-dark-text/70">8.5 × 6.2 × 3.8 متر</span>
                        </div>
                      </div>
                      <div className="space-y-4">
                        <div className="flex items-center justify-between p-4 bg-luxury-ivory rounded-lg">
                          <span className="font-medium text-dark-text">مدة التنفيذ</span>
                          <span className="text-dark-text/70">8-10 أسابيع</span>
                        </div>
                        <div className="flex items-center justify-between p-4 bg-luxury-ivory rounded-lg">
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                      <div className="space-y-4">
                        <div className="flex items-start gap-3">
                          ...
                          <span className="text-dark-text/80">خشب بلوط عالي الجودة</span>
                        </div>
                        <div className="flex items-start gap-3">
                          <div className="w-2 h-2 bg-luxury-gold rounded-full mt-2"></div>
                          <span className="text-dark-text/80">أبواب زجاجية أمان</span>
                        </div>
                        <div className="flex items-start gap-3">
                          <div className="w-2 h-2 bg-luxury-gold rounded-full mt-2"></div>
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="flex items-start gap-3">
                          <div className="w-2 h-2 bg-luxury-gold rounded-full mt-2"></div>
                          <span className="text-dark-text/80">مساحة عرض مثالية</span>
                        </div>
                      </div>
                    </div>
                  </CardContent>
              ...
              <div className="space-y-6">
                ...
                <Card className="bg-white border-luxury-gold/30 shadow-xl">
                  ...
                  <CardContent className="space-y-4">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="font-bold text-luxury-navy">2,567</span>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-dark-text/70">الإعجابات</span>
                      <span className="font-bold text-luxury-navy">189</span>
                    </div>
                    <div className="flex items-center justify-between">
                ...
                <Card className="bg-luxury-navy text-luxury-ivory border-luxury-gold/30 shadow-xl">
                  <CardHeader>
                    <CardTitle className="text-xl font-bold text-luxury-ivory">
                      هل تريد معرض داخلي مماثل؟
                    </CardTitle>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    <p className="text-luxury-ivory/80 text-sm">
                      تواصل معنا اليوم للحصول على استشارة مجانية وتصميم معرضك الداخلي الفاخر
                    </p>
                    <Button
                      asChild
                ...
                <Card className="bg-white border-luxury-gold/30 shadow-xl">
                  ...
                  <CardContent className="space-y-4">
                    <Link href="/woodworking-gallery/interior-showroom-1" className="block p-4 bg-luxury-ivory rounded-lg hover:bg-luxury-gold/10 transition-colors">
                      <h4 className="font-semibold text-dark-text mb-2">معرض داخلي فاخر مع وحدات خشبية مدمجة</h4>
                      <p className="text-sm text-dark-text/70">معرض حديث وفاخر يضم وحدات خشبية مدمجة</p>
                    </Link>
        ...
        <section className="w-full py-16 md:py-24 bg-luxury-navy text-luxury-ivory">
          <div className="container px-4 md:px-6 text-center">
            <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl mb-6">
              هل أعجبك المعرض الداخلي الفاخر هذا؟
            </h2>
            <p className="text-lg text-luxury-ivory/80 max-w-2xl mx-auto mb-8">
              تواصل معنا اليوم للحصول على استشارة مجانية وتصميم معرضك الداخلي الفاخر بأعلى معايير الجودة
            </p>
