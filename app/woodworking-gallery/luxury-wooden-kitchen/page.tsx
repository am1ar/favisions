...
export default function LuxuryWoodenKitchenDetailPage() {
  return (
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <div className="flex items-center gap-6 text-sm text-luxury-ivory/80">
                  <div className="flex items-center gap-2">
                    ...
                    <span>8 ديسمبر 2023</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <Eye className="h-4 w-4" />
                    <span>3,245 مشاهدة</span>
                  </div>
                  <div className="flex items-center gap-2">
              ...
              <div className="relative">
                <div className="relative w-full h-80 md:h-96 rounded-2xl overflow-hidden shadow-2xl">
                  <Image
                    src="/woodworking-images/luxury-wooden-kitchen.svg"
                    alt="مطبخ فاخر مع خزائن خشبية طبيعية"
                    fill
                    className="object-cover"
                  />
                  <Image
                    src="/woodworking-images/ng/9.jpg"
                    alt="مطبخ فاخر مع خزائن خشبية طبيعية"
                    fill
                    className="object-cover"
                  />
                ...
                <Card className="bg-white border-luxury-gold/30 shadow-xl">
                  ...
                  <CardContent className="space-y-6">
                    <p className="text-dark-text/80 leading-relaxed text-lg">
                      هذا المطبخ يمثل مثالاً رائعاً على التصميم العصري والعملي، حيث تم استخدام خزائن خشبية طبيعية عالية الجودة مع خشب البلوط لإنشاء مطبخ أنيق يعمل بكفاءة عالية. التصميم يجمع بين الأناقة المعاصرة والراحة العملية.
                    </p>
                    <p className="text-dark-text/80 leading-relaxed text-lg">
                      الخزائن الخشبية الطبيعية توفر مساحة تخزين مثالية مع الحفاظ على الأناقة، مع تصميم عصري ومينيمال يناسب جميع أنواع المنازل. تم استخدام مواد عالية الجودة لضمان المتانة والاستدامة.
                    </p>
                  </CardContent>
                </Card>
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                      <div className="space-y-4">
                        ...
                        <div className="flex items-center justify-between p-4 bg-luxury-ivory rounded-lg">
                          ...
                          <span className="text-dark-text/70">خزائن مطبخ</span>
                        </div>
                        <div className="flex items-center justify-between p-4 bg-luxury-ivory rounded-lg">
                          <span className="font-medium text-dark-text">الأبعاد</span>
                          <span className="text-dark-text/70">6.5 × 4.2 × 2.6 متر</span>
                        </div>
                      </div>
                      <div className="space-y-4">
                        <div className="flex items-center justify-between p-4 bg-luxury-ivory rounded-lg">
                  ...
                  <CardContent>
                    <div className="grid md:grid-cols-2 gap-6">
                      <div className="space-y-4">
                        ...
                        <div className="flex items-start gap-3">
                          <div className="w-2 h-2 bg-luxury-gold rounded-full mt-2"></div>
                          <span className="text-dark-text/80">خزائن مطبخ مدمجة</span>
                        </div>
                        <div className="flex items-start gap-3">
                          <div className="w-2 h-2 bg-luxury-gold rounded-full mt-2"></div>
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="flex items-start gap-3">
                          <div className="w-2 h-2 bg-luxury-gold rounded-full mt-2"></div>
                          <span className="text-dark-text/80">مساحة عمل مثالية</span>
                        </div>
                      </div>
                    </div>
                  </CardContent>
              ...
              <div className="space-y-6">
                ...
                <Card className="bg-white border-luxury-gold/30 shadow-xl">
                  ...
                  <CardContent className="space-y-4">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="font-bold text-luxury-navy">3,245</span>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-dark-text/70">الإعجابات</span>
                      <span className="font-bold text-luxury-navy">234</span>
                    </div>
                    <div className="flex items-center justify-between">
                ...
                <Card className="bg-luxury-navy text-luxury-ivory border-luxury-gold/30 shadow-xl">
                  ...
                  <CardContent className="space-y-4">
                    <p className="text-luxury-ivory/80 text-sm">
                      تواصل معنا اليوم للحصول على استشارة مجانية وتصميم مطبخك الفاخر
                    </p>
                    <Button
                      asChild
                ...
                <Card className="bg-white border-luxury-gold/30 shadow-xl">
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <Link href="/woodworking-gallery/utility-room-cabinets" className="block p-4 bg-luxury-ivory rounded-lg hover:bg-luxury-gold/10 transition-colors">
                      <h4 className="font-semibold text-dark-text mb-2">غرفة مرافق مع خزائن خشبية مدمجة</h4>
                      <p className="text-sm text-dark-text/70">غرفة مرافق مع خزائن خشبية مدمجة</p>
                    </Link>
                  </CardContent>
                </Card>
              </div>
        ...
        <section className="w-full py-16 md:py-24 bg-luxury-navy text-luxury-ivory">
          <div className="container px-4 md:px-6 text-center">
            <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl mb-6">
              هل أعجبك المطبخ الفاخر هذا؟
            </h2>
            <p className="text-lg text-luxury-ivory/80 max-w-2xl mx-auto mb-8">
              تواصل معنا اليوم للحصول على استشارة مجانية وتصميم مطبخك الفاخر بأعلى معايير الجودة
            </p>
