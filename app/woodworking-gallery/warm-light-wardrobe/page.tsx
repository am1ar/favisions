...
export default function WarmLightWardrobeDetailPage() {
  return (
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <h1 className="text-4xl font-bold tracking-tighter sm:text-5xl md:text-6xl text-luxury-ivory mb-6 drop-shadow-lg">
                  خزانة ملابس فاخرة مع إضاءة دافئة
                </h1>
                <p className="text-lg md:text-xl text-luxury-ivory/90 leading-relaxed mb-8">
                  خزانة ملابس فاخرة مع إضاءة LED دافئة متكاملة، مصنوعة من خشب داكن عالي الجودة مع تصميم أنيق ومعاصر
                </p>
              ...
              <div className="relative">
                <div className="relative w-full h-80 md:h-96 rounded-2xl overflow-hidden shadow-2xl">
                  <Image
                    src="/woodworking-images/warm-light-wardrobe.svg"
                    alt="خزانة ملابس فاخرة مع إضاءة دافئة"
                    fill
                    className="object-cover"
                  />
                  <Image
                    src="/woodworking-images/ng/15.jpg"
                    alt="خزانة ملابس فاخرة مع إضاءة دافئة"
                    fill
                    className="object-cover"
                  />
                ...
                <Card className="bg-white border-luxury-gold/30 shadow-xl">
                  ...
                  <CardContent className="space-y-6">
                    <p className="text-dark-text/80 leading-relaxed text-lg">
                      هذه الخزانة تمثل مثالاً رائعاً على التصميم الفاخر والعملي، حيث تم استخدام خشب الجوز الداكن لإنشاء خزائن أنيقة تعمل بكفاءة عالية. التصميم يجمع بين الأناقة المعاصرة والراحة العملية.
                    </p>
                    <p className="text-dark-text/80 leading-relaxed text-lg">
                      الإضاءة LED الدافئة توفر جوًا مريحًا وأنيقًا، مع تصميم عصري ومينيمال يناسب جميع أنواع المنازل. تم استخدام مواد عالية الجودة لضمان المتانة والاستدامة.
                    </p>
                  </CardContent>
                </Card>
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                      <div className="space-y-4">
                        ...
                        <div className="flex items-center justify-between p-4 bg-luxury-ivory rounded-lg">
                          ...
                          <span className="text-dark-text/70">خزائن ملابس</span>
                        </div>
                        <div className="flex items-center justify-between p-4 bg-luxury-ivory rounded-lg">
                  ...
                  <CardContent>
                    <div className="grid md:grid-cols-2 gap-6">
                      <div className="space-y-4">
                        ...
                        <div className="flex items-start gap-3">
                          <div className="w-2 h-2 bg-luxury-gold rounded-full mt-2"></div>
                          <span className="text-dark-text/80">إضاءة LED دافئة متكاملة</span>
                        </div>
                        <div className="flex items-start gap-3">
                          <div className="w-2 h-2 bg-luxury-gold rounded-full mt-2"></div>
                          <span className="text-dark-text/80">خزائن متعددة مع أبواب انزلاقية</span>
                        </div>
                      </div>
                      <div className="space-y-4">
                        <div className="flex items-start gap-3">
