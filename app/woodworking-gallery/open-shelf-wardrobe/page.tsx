...
export default function OpenShelfWardrobeDetailPage() {
  return (
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <h1 className="text-4xl font-bold tracking-tighter sm:text-5xl md:text-6xl text-luxury-ivory mb-6 drop-shadow-lg">
                  خزانة ملابس فاخرة مع رفوف مفتوحة
                </h1>
                <p className="text-lg md:text-xl text-luxury-ivory/90 leading-relaxed mb-8">
                  خزانة ملابس فاخرة مع رفوف مفتوحة وخشب طبيعي عالي الجودة، مصممة بأسلوب عصري مع سهولة في الوصول والتنظيم
                </p>
                ...
                <div className="flex items-center gap-6 text-sm text-luxury-ivory/80">
                  <div className="flex items-center gap-2">
                    ...
                    <span>15 ديسمبر 2023</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <Eye className="h-4 w-4" />
                    <span>2,134 مشاهدة</span>
                  </div>
                  <div className="flex items-center gap-2">
              ...
              <div className="relative">
                <div className="relative w-full h-80 md:h-96 rounded-2xl overflow-hidden shadow-2xl">
                  <Image
                    src="/woodworking-images/open-shelf-wardrobe.svg"
                    alt="خزانة ملابس فاخرة مع رفوف مفتوحة"
                    fill
                    className="object-cover"
                  />
                  <Image
                    src="/woodworking-images/ng/6.jpg"
                    alt="خزانة ملابس فاخرة مع رفوف مفتوحة"
                    fill
                    className="object-cover"
                  />
                ...
                <Card className="bg-white border-luxury-gold/30 shadow-xl">
                  ...
                  <CardContent className="space-y-6">
                    <p className="text-dark-text/80 leading-relaxed text-lg">
                      هذه الخزانة تمثل مثالاً رائعاً على التصميم العصري والعملي، حيث تم استخدام رفوف مفتوحة مع خشب البلوط الطبيعي لإنشاء خزائن أنيقة تعمل بكفاءة عالية. التصميم يجمع بين الأناقة المعاصرة والراحة العملية.
                    </p>
                    <p className="text-dark-text/80 leading-relaxed text-lg">
                      الرفوف المفتوحة توفر سهولة في الوصول والتنظيم، مع تصميم عصري ومينيمال يناسب جميع أنواع المنازل. تم استخدام مواد عالية الجودة لضمان المتانة والاستدامة.
                    </p>
                  </CardContent>
                </Card>
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                      <div className="space-y-4">
                        ...
                        <div className="flex items-center justify-between p-4 bg-luxury-ivory rounded-lg">
                          ...
                          <span className="text-dark-text/70">رفوف مفتوحة</span>
                        </div>
                        <div className="flex items-center justify-between p-4 bg-luxury-ivory rounded-lg">
                          <span className="font-medium text-dark-text">الأبعاد</span>
                          <span className="text-dark-text/70">3.5 × 2.8 × 2.6 متر</span>
                        </div>
                      </div>
                      <div className="space-y-4">
                        <div className="flex items-center justify-between p-4 bg-luxury-ivory rounded-lg">
                ...
                <Card className="bg-white border-luxury-gold/30 shadow-xl">
                  ...
                  <CardContent className="space-y-4">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="font-bold text-luxury-navy">2,134</span>
                    </div>
                    <div className="flex items-center justify-between">
                ...
                <Card className="bg-white border-luxury-gold/30 shadow-xl">
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <Link href="/woodworking-gallery/frosted-glass-wardrobe" className="block p-4 bg-luxury-ivory rounded-lg hover:bg-luxury-gold/10 transition-colors">
                      ...
                      <p className="text-sm text-dark-text/70">خزانة ملابس فاخرة مع زجاج معتم</p>
                    </Link>
                  </CardContent>
                </Card>
              </div>
